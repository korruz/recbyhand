...
if __name__ == "__main__":
    ...
    recomedations_by_userCF = trainUserCF(
        user_items_train, b_sim.cos4set, user_all_items, k=5
    )
    recomedations_by_itemCF = trainItemCF(
        item_users_train, b_sim.cos4set, user_all_items, k=5
    )
